...
void plot_histo_2D(TString path, TString inputfile, TString title, TString title_name){
  ...
  //t_E->SetBranchAddress("obt_MCAL", &obt);
  t_E->SetBranchAddress("obt_GRID", &obt);
...
//  t_E->SetBranchAddress("Etot_MCAL", &energy);
  ...
  */
  ...
  c2->Print(path + "plots/plot1_" + title_name + "_TGF.jpg");
  // #########################################################
  // #########################################################
  /*
...
int H3_plot(){
  ...
  TString path_GRID_less_2015 = "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/GRID/2008_2015/";
  //
  plot_histo_2D( path_GRID_less_2015,  "histo_tree/*.root",  "GRID",  "GRID_name");


  TString path_GRID = "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/GRID/2015/";
  //plot_histo_2D( path_GRID,  "histo_tree/*.root",  "GRID",  "GRID_name");
