int plot(TString save_path, TString inputfile, double t0, int contact, int usec, double propagation_time, double &obt_MCAL_mean)
{
  ...
  hlc2->GetXaxis()->SetTitle("#deltat [sec]");
  ...
  char str2[200];	// T0 =
  sprintf(str2,"Time_WWLLN %.6f ", t0);
  t1.DrawTextNDC(xpos, zpos-0.2, str2);
  char str5[200];	// T0 =
  sprintf(str5,"Contact %d ", contact);
  t1.DrawTextNDC(xpos, zpos-0.3, str5);

  // plot energy vs. time plot
  c1->cd(2);
  h2e->Draw();
  h2e->SetStats(0);
  h2e->GetXaxis()->SetTitle("#deltat [sec]");
  ...
  ge->Draw("Psame");
  // save picture
  TString filename = std::to_string(contact) + "_" + std::to_string(t0);
  c1->Print(save_path + "plots/Lightcurves/png/" + filename +".png");
  c1->Print(save_path + "plots/Lightcurves/eps/" + filename +".eps");
...
int plot_light_curve_single_TGF_8(TString path_candidate, TString path_MCAL, TString name_year){
  ...
  */
  ...
  TFile *g = new TFile(path_candidate + "trg_PAPER_with_simultaneous_WWLLN_TIMING_ANGLES.root", "r");
  ...
  */
  ...
  for (int i = 0; i < entries_candidate; i++) {
    ...
    for (int j = 0; j < entries_WWLLN_match; j++) {
      ...
      if (TMath::Abs(time_WWLLN_match - t_WWLLN) < 0.004) {
        break_variable = 1;
        cout << time_WWLLN_match << " " << t_WWLLN << endl;
      }
    }
...
int K_plot_TGF_candidates(){
  ...
  //plot_light_curve_single_TGF_8("/Volumes/TOSHIBA/fresh_WWLLN_AGILE/AC_disabled_analyse/", "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/MCAL_2015/", "2015_0.100000_5");
  ...
  //plot_light_curve_single_TGF_8("/Volumes/TOSHIBA/fresh_WWLLN_AGILE/Time_drift_2017/", "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/MCAL_2016/", "2016_2017_0.100000_7");
  ...
  //plot_light_curve_single_TGF_8("/Volumes/TOSHIBA/fresh_WWLLN_AGILE/Time_drift_2017/", "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/MCAL_2016/", "2016_2017_0.020000_7");
  ...
  //plot_light_curve_single_TGF_8("/Volumes/TOSHIBA/fresh_WWLLN_AGILE/Time_drift_2018_NEWDRIFT/", "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/MCAL_55936_56996/", "2018_0.020000_6");
  //plot_light_curve_single_TGF_8("/Volumes/TOSHIBA/fresh_WWLLN_AGILE/Time_drift_2018_NEWDRIFT/", "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/MCAL_55936_56996/", "2018_0.500000_6");

  //plot_light_curve_single_TGF_8("/Volumes/TOSHIBA/fresh_WWLLN_AGILE/3DFIX_4ms/", "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/MCAL_55000_57216_TIME_CORRECTED_4ms/", "2018_0.500000_6");

  //plot_light_curve_single_TGF_8("/Volumes/TOSHIBA/fresh_WWLLN_AGILE/3DFIX_0ms/", "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/MCAL_55653_57217_TIME_CORRECTED_0ms/", "2018_0.500000_5");
  //plot_light_curve_single_TGF_8("/Volumes/TOSHIBA/fresh_WWLLN_AGILE/3DFIX_0ms/", "/Volumes/TOSHIBA/fresh_WWLLN_AGILE/MCAL_55653_57217_TIME_CORRECTED_0ms/", "2018_0.000500_5");
